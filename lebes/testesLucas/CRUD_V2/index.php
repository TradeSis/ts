...
var wTitulo = {
          "view": "label",
          "label": "App CRUD - V2 Registro Reunião",
          "id": "wTitulo",
          "height": 0
        };
...
const table_tarefas = {                 //# 2- Modificação!
   ...
   // url:"data/data.js",
    hover:"myhover",
    save:/* "/ts/erp/testes/crud/save.php" */  "/ts/erp/testes/testesLucas/CRUD_V2/save.php", /* PHP SAVE IN MYSQL */                    //****************##########1 */
...
// alert ("periodo selecionado: " + wvar);
  wJson = chamaAJAX("/ts/erp/testes/testesLucas/CRUD_v2/leitura.php");                         //# 9- Modificação! NOVA****
